...
return [
    ...
    'modal_close_add' => "Cancel Add",
    'modal_close_delete' => "Cancel Delete",
    'modal_close' => "Close Modal",
    'modal_close_edit' => "Cancel Edit",
    ...
    'modal_delete_city_description' => "Do you really want to delete these destination? This process cannot be undone.",
];
